...
if ans == "1":
    ...
    print("Percentage of list that is empty:",round(((len(H.item) - count)/len(H.item)),2))
    print("Standard deviation of the lengths of the lists:",statistics.stdev(lenOfList(H)))
    print("Reading word file to determine similarities")
    print()
    print("Word similarities found:")
